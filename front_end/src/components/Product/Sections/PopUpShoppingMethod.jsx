...
function PopUpShoppingMethod(props) {
   ...
   const {checkboxChange, shippingMethodIndex,  shippingInfo={shippingInfo}, setIsPopUpShippingOpen, isPopUpShippingOpen} = props;
        ...
        return (
          <div className="methods_container" key={index}>
            <div className="shipping-type">
              <span className="shipping-method">{item.methodName.toUpperCase()}</span>
